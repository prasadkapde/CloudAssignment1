...
public class VirtualMachine {
	...
	public void createVirtualMachine(int numberOfVirualMachines)
			throws IOException {
	...
	public void createAMI(String instanceId) throws IOException {
		AWSCredentials credentials = new PropertiesCredentials(
				VirtualMachine.class
						.getResourceAsStream("AwsCredentials.properties"));
		ec2 = new AmazonEC2Client(credentials);
	...
	public List<Instance> getInstanceList() throws IOException {
		...
		for(Instance ins : instances){
			if(ins.getState().getName().equals("running") || ins.getState().getName().equals("pending")){
